...
var DISABLE_TYPES = ['Button', 'Slider', 'Switch', 'Text', 'TouchableHighlight', 'TouchableOpacity', 'TouchableWithoutFeedback', 'View', 'TextInput'];
...
function isElementDisabled(element) {
  ...
  var stateDisabled = (0, _ramda.compose)((0, _ramda.includes)('disabled'), (0, _ramda.defaultTo)([]), (0, _ramda.path)(['props', 'accessibilityStates']))(element);
  return Boolean(DISABLE_TYPES.includes((0, _utils.getType)(element)) && (propDisabled || stateDisabled));
}
